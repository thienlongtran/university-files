...
public class SortersTester {
  ...
  public void testBubbleSort() {
    ...
    Sorters2120.bubbleSort(pack);
    assertTrue(isInOrder(pack));
    System.out.println("Bubble Sort Test: Pass");
  }
  ...
  public void testSelectionSort() {
    ...
    Sorters2120.selectionSort(pack);
    assertTrue(isInOrder(pack));
    System.out.println("Selection Sort Test: Pass");
  }
  ...
  public void testMergeSort() {
    ...
    Sorters2120.mergeSort(pack);
    assertTrue(isInOrder(pack));
    System.out.println("Merge Sort Test: Pass");
  }
  ...
  public void testIndexOf() {
    ...
    System.out.println("Recursive Binary-Search IndexOf Test: Pass");
  }
}
