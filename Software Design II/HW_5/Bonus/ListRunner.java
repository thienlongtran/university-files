public class ListRunner {
    ...
    public static void main(String[] args) {
        ...
        // structure
        LinkedList<Dog>.Iterator<Dog> iter1 = myDogList.getIterator();
        LinkedList<Dog>.Iterator<Dog> iter2 = myDogList.getIterator();

        System.out.println();
        System.out.println();

        System.out.println("Iterating using Iterators!!! - Iter 1");
        while (iter1.hasNext()) {
            Dog foo = iter1.next();
        ...
        Dog testDog = new Dog("Leonard", 22, 123);
        System.out.println(myDogList.indexOf(testDog));
    }// end main
