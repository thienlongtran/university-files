...
public class Country implements Comparable
{
    ...
    public boolean equals(Object obj) {
        ...
        this.getPowerLevel() == otherCountry.getPowerLevel() &&
        this.getNationalDish().equals(otherCountry.getNationalDish())){
            return true;
        }
    ...
    public int compareTo(Object arg0) {
        ...
        else if (this.getName().compareTo(otherCountry.getName()) > 1){
            return 1;
        }
        else{
            return -1;
